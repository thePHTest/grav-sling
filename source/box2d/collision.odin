...
// World-space cast output. In single precision this is identical to CastOutput.
...
ShapeCastPairInput :: struct {
	...
	translationB: Vec2, // The translation of shape B, in A's frame
...
TOIOutput :: struct {
	...
	point:    Vec2,     // The hit point
	normal:   Vec2,     // The hit normal
...
// This function receives clipped box cast input for a proxy. The function
// returns the new ray fraction.
// - return a value of 0 to terminate the ray cast
// - return a value less than input->maxFraction to clip the ray
// - return a value of input->maxFraction to continue the ray cast without clipping
TreeBoxCastCallbackFcn   :: #type proc "c" (#by_ptr input: BoxCastInput, proxyId: i32, userData: u64, ctx: rawptr) -> f32

// Low level box cast input data
BoxCastInput :: struct {
